...
const Contact = () => {
  ...
  return (
    <div className="max-w-[1300px] md:py-20 pt-32 w-full mx-auto" id="contact">
      <h1 className="pop md:text-6xl text-3xl font-semibold text-center mb-14 md:mt-5 mt-28">
        Contact Me
      </h1>
      <div className="mx-auto flex flex-col md:flex-row bg-white shadow-xl rounded-lg p-10 gap-10">
        <div className="w-full md:w-[55%]">
          ...
          <form className="robo flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="robo flex items-center justify-center bg-[#E74C3C] text-white py-3 rounded-lg text-lg font-semibold hover:bg-[#C0392B] transition-all"
              disabled={loading}
            >
              {loading ? (
                "Sending..."
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 text-gray-700">
              ...
              <a
                ...
                className="hover:underline"
              >
                <button className="rounded-full font-medium text-xl bg-black text-white py-2 px-2">
                  Download CV
                </button>
              </a>
            </div>
